...
imags for the demo apps are already present in Docker Hub. If you run into rate limits while experimenting with the cluster, you'll need to set up a Docker Hub account and configure Docker to use your Docker Hub credentials.
